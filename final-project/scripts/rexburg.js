...
weatherObject.open('GET', 'https://api.openweathermap.org/data/2.5/weather?id=5605242&appid=9a639e9b88f8f96c233986dc5ceb5877&units=imperial', true);
weatherObject.send();
...
function myMap() {
    var mapProp = {
        center: new google.maps.LatLng(43.8099281,-111.7825463),
        zoom: 15,
    };
